...
const d = await browser.newContext({ viewport:{width:1280,height:860}, deviceScaleFactor:2, locale:'ja-JP' })
...
await shot('/admin','a1-dashboard.png',true)
await shot('/admin/reports','a2-reports.png',true)
await shot('/admin/summary','a3-summary.png',true)
await shot('/admin/sites','a4-sites.png',true)
await shot(\`/admin/site/$SITE_ID\`,'a5-sitedetail.png',true,3500)
await shot('/admin/subs','a6-subs.png',true)
await shot('/admin/work-types','a7-worktypes.png',true)
await shot('/admin/settings','a8-settings.png',true)
